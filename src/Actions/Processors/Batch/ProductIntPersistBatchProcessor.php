...
/**
 * TechDivision\Import\Actions\Processors\Batch\ProductIntPersistBatchProcessor
 *
 * NOTICE OF LICENSE
 *
...
/**
 * The product integer attribute persist batch processor implementation.
 *
 * @author    Tim Wagner <tw@appserver.io>
 * @copyright 2015 TechDivision GmbH <info@appserver.io>
 * @license   http://opensource.org/licenses/osl-3.0.php Open Software License (OSL 3.0)
 ...
 * @link      http://www.appserver.io
 */
class ProductIntPersistBatchProcessor extends AbstractPersistBatchProcessor
{
    ...
    {
        return SqlStatements::CREATE_PRODUCT_INT;
    }
}
